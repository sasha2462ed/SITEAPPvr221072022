                                                                ...
                                                                public void onResponse(JSONArray response) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        for (int i = 0; i < name.length(); i++) {
                                                                            ...
                                                                            no.put(name.get(i).toString(), id.get(i).toString());
                                                                        }
                                                                        ArrayAdapter<String> adapterg = new ArrayAdapter<String>(getApplicationContext(),R.layout.listview_items, problemas);
                                                                        lv50.setAdapter(adapterg);
